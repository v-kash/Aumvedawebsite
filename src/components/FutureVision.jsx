  ...
  return (
    <section className="py-16 px-[8%] bg-[#f8f4ef]">
      ...
      <div className="mb-12 text-center">
        <p className="font-jost text-left text-[11px] tracking-[0.18em] uppercase text-[#6f8a6a] ">
          Future Vision
        </p>

        <h2 className="font-cormorant text-[48px] text-[#2f2a25]">
          Looking Ahead
        </h2>
      </div>
...
"
            ...
            {/* Title */}
            <h3 className="font-cormorant text-[19px] text-[#2f2a25] mb-1">
              {item.title}
            </h3>

            {/* Subtitle */}
            <p className="text-[12px] tracking-[0.15em] text-[#9a9a9a] mb-4 uppercase">
              {item.subtitle}
            </p>

            {/* Number */}
            <div className="flex items-center mb-4">
              <span className="text-[#5a7a4a] text-[11px] px-2 py-1 border-[1px] border-[#e6e1d8]">
                {item.year}
              </span>
            </div>

            {/* Text */}
            <p className="text-[14px] text-[#6b6b6b] leading-6 font-light">
              {item.text}
            </p>
          </motion.div>
        ))}
